...
//            MDetailBean bean= all.get(adapterPosition);
//            bean.delete();
//
//            CollectFragment.this.all.remove(adapterPosition);
//            recycleCommonAdapter.notifyItemRemoved(adapterPosition);
//            recycleCommonAdapter.notifyItemRangeChanged(adapterPosition, CollectFragment.this.all.size());
//        }
//        @Override
//        public boolean onMove(int srcPosition, int targetPosition) {
//            recycleCommonAdapter.notifyItemMoved(srcPosition,targetPosition);
//            return false;
//        }
//    })    ;
